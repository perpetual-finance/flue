...
Programmatic `harness.prompt(...)` calls made directly from your own code are not recovered this way: like other programmatic harness calls, they have no durable submission to resume from.
