...
const agent = defineAgent(() => ({
	...
	tools,
	skills,
	actions: [triageIssue], // application-controlled operations the model can run
}));
...
- [Actions](/docs/guide/actions/) — finite, application-controlled operations an agent can run.
