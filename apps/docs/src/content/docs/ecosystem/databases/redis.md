...
persists canonical agent conversations, immutable attachments, and accepted submissions so that they survive Flue process restarts. Durability across Redis server loss
